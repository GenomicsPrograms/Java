// Modified by ML 
// Source: https://www.quickprogrammingtips.com/java/how-to-copy-files-from-one-folder-to-another-in-java.html
...
public class CopyFilesWithExtension {
	...
	public static void main(String[] args) {
		...
		String sourceFolder = "C:\\Users\\name\\Documents\\Research\\source\\";
		String targetFolder = "C:\\Users\\name\\Documents\\Research\\target\\";
		...
		File[] sourceFiles = sFile.listFiles(new FilenameFilter() {
			...
			public boolean accept(File dir, String name) {
				if(name.contains("your_text")) {// change this to your string
					return true;
				}else {  
					return false;
				}
